...
class TestPostAPI:
    ...
    def test_post_patch_current(self, user_client, post, comment_1_post, comment_2_post):
        response = user_client.retrieve(f'/api/v1/posts/{post.id}/comments/{comment_1_post.id}/')
        ...
        response = user_client.retrieve(f'/api/v1/posts/{post.id}/comments/{comment_2_post.id}/')
